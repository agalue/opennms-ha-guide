...
For this tutorial, we're going to use _PostgreSQL 9.6_ and the provided versions for _repmgr_ and _pgpool-II_ on the _PGDG_ repository for that version of PostgreSQL.
