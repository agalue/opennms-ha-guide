...
The test system must have at least 8 GB of RAM with a quad-core processor.  The test environment will require 5 VMs. Two VMs require 2GB for a total of 7GB.
...
The above file will setup 5 machines using latest _CentOS 7_.
