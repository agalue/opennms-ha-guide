...
[source, bash]
----
[root@pgdbsrv01 ~]# service postgresql-9.5 initdb
...
[source, bash]
----
[root@pgdbsrv01 ~]# /usr/pgsql-9.5/bin/postgresql95-setup initdb
Initializing database ... OK
----

Configure database access by editing `/var/lib/pgsql/9.5/data/pg_hba.conf`, and adding the following content:
...
As you can see, _md5_ has been added to all combinations of user/database/server, to ensure that a password will be required to connect to any database.

Configure _PostgreSQL_ itself and streaming replication by editing `/var/lib/pgsql/9.5/data/postgresql.conf`, and updating the following attributes:
...
[source, bash]
----
[root@pgdbsrv01 ~]$ chown postgres:postgres /etc/repmgr/9.5/repmgr.conf
----
...
[source, bash]
----
[root@pgdbsrv01 ~]# chkconfig postgresql-9.5 on
[root@pgdbsrv01 ~]# service postgresql-9.5 start
...
[source, bash]
----
[root@pgdbsrv01 ~]# systemctl enable postgresql-9.5
ln -s '/usr/lib/systemd/system/postgresql-9.5.service' '/etc/systemd/system/multi-user.target.wants/postgresql-9.5.service'
[root@pgdbsrv01 ~]# systemctl start postgresql-9.5
----
...
----
[root@pgdbsrv01 ~]$ sudo su - postgres
-bash-4.1$ /usr/pgsql-9.5/bin/repmgr -f /etc/repmgr/9.5/repmgr.conf --verbose master register
[2016-06-17 12:42:11] [NOTICE] using configuration file "/etc/repmgr/9.5/repmgr.conf"
[2016-06-17 12:42:11] [INFO] connecting to master database
[2016-06-17 12:42:11] [INFO] connected to master, checking its state
[2016-06-17 12:42:11] [INFO] master register: creating database objects inside the repmgr_opennms_cluster schema
[2016-06-17 12:42:11] [INFO] retrieving node list for cluster 'opennms_cluster'
[2016-06-17 12:42:11] [WARNING] get_master_node_id(): no active primary found
[2016-06-17 12:42:11] [NOTICE] master node correctly registered for cluster opennms_cluster with id 1 (conninfo: host=pgdbsrv01 user=repmgr dbname=repmgr)
----
...
Configure _repmgr_ similar to the primary by creating `/etc/repmgr/9.5/repmgr.conf` with the following content:
...
[source, bash]
----
[root@pgdbsrv02 ~]$ chown postgres:postgres /etc/repmgr/9.5/repmgr.conf
----
...
-bash-4.1$ /usr/pgsql-9.5/bin/repmgr -f /etc/repmgr/9.5/repmgr.conf --verbose -D /var/lib/pgsql/9.5/data -d repmgr -p 5432 -U repmgr -R postgres standby clone pgdbsrv01
2016-06-17 12:47:17] [NOTICE] using configuration file "/etc/repmgr/9.5/repmgr.conf"
[2016-06-17 12:47:17] [NOTICE] destination directory '/var/lib/pgsql/9.5/data' provided
[2016-06-17 12:47:17] [INFO] connecting to upstream node
[2016-06-17 12:47:17] [INFO] connected to upstream node, checking its state
[2016-06-17 12:47:17] [INFO] Successfully connected to upstream node. Current installation size is 28 MB
[2016-06-17 12:47:17] [INFO] creating directory "/var/lib/pgsql/9.5/data"...
[2016-06-17 12:47:17] [NOTICE] starting backup (using pg_basebackup)...
[2016-06-17 12:47:17] [HINT] this may take some time; consider using the -c/--fast-checkpoint option
[2016-06-17 12:47:17] [INFO] executing: '/usr/pgsql-9.5/bin/pg_basebackup -l "repmgr base backup"  -D /var/lib/pgsql/9.5/data -h pgdbsrv01 -p 5432 -U repmgr --xlog-method=stream'
[2016-06-17 12:47:17] [NOTICE] standby clone (using pg_basebackup) complete
[2016-06-17 12:47:17] [NOTICE] you can now start your PostgreSQL server
[2016-06-17 12:47:17] [HINT] for example : pg_ctl -D /var/lib/pgsql/9.5/data start
[2016-06-17 12:47:17] [HINT] After starting the server, you need to register this standby with "repmgr standby register"
-bash-4.1$ exit
logout
----
...
In case you experience problems with the synchronization and you need to repeat this step, first delete the contents of the _PostgreSQL_ datadir (`rm -rf /var/lib/pgsql/9.5/data/*`) and try again.

On _RHEL/CentOS 6_:

[source, bash]
----
[root@pgdbsrv02 ~]# chkconfig postgresql-9.5 on
[root@pgdbsrv02 ~]# service postgresql-9.5 start
Starting postgresql-9.5 service:                           [  OK  ]
----
...
[source, bash]
----
[root@pgdbsrv02 ~]# systemctl enable postgresql-9.5
ln -s '/usr/lib/systemd/system/postgresql-9.5.service' '/etc/systemd/system/multi-user.target.wants/postgresql-9.5.service'
[root@pgdbsrv02 ~]# systemctl start postgresql-9.5
----
...
----
[root@pgdbsrv02 ~]$ su - postgres
-bash-4.1$ /usr/pgsql-9.5/bin/repmgr -f /etc/repmgr/9.5/repmgr.conf --verbose standby register
[2016-06-17 12:50:17] [NOTICE] using configuration file "/etc/repmgr/9.5/repmgr.conf"
[2016-06-17 12:50:17] [INFO] connecting to standby database
[2016-06-17 12:50:17] [INFO] connecting to master database
[2016-06-17 12:50:17] [INFO] retrieving node list for cluster 'opennms_cluster'
[2016-06-17 12:50:17] [INFO] checking role of cluster node '1'
[2016-06-17 12:50:17] [INFO] registering the standby
[2016-06-17 12:50:17] [INFO] standby registration complete
[2016-06-17 12:50:17] [NOTICE] standby node correctly registered for cluster opennms_cluster with id 2 (conninfo: host=pgdbsrv02 user=repmgr dbname=repmgr)
-bash-4.1$ exit
logout
----

WARNING: In intentional failover situations, you can stop the primary first and make sure all its data has been flushed. In a true failure of the primary situation, this will not be possible. Some recent transactions (the ones not yet shipped to the standby) committed on the primary may not be available on the standby that's now promoted to being a primary.

=== Test Replication

First, let’s check that all the servers are running the proper role.
The primary/master server should not have a `recovery.conf` file, but this file should exist on each standby server.
...
If the value is true, you're on a slave (or standby) server; otherwise, you’re on the master/primary server:
...
NOTE: Note that the above query has been executed against the primary server.

WARNING: It is important to have in mind that the name of the view starts with the word `repmgr`, then the underscore character (`_`), and then the name of the cluster (in this case, `opennms_cluster`, as it was defined on `repmgr.conf`); in other words: `repmgr_opennms_cluster`.
...
[source, bash]
----
[root@pgdbsrv01 ~]# su - postgres -c "/usr/pgsql-9.5/bin/repmgr -f /etc/repmgr/9.5/repmgr.conf cluster show"
[2016-06-17 12:56:40] [INFO] connecting to database
Role      | Name      | Upstream  | Connection String
----------+-----------|-----------|-----------------------------------------
* master  | pgdbsrv01 |           | host=pgdbsrv01 user=repmgr dbname=repmgr
  standby | pgdbsrv02 | pgdbsrv01 | host=pgdbsrv02 user=repmgr dbname=repmgr
----
...
client_port      | 57035
backend_start    | 2016-06-17 12:49:46.922831-04
backend_xmin     |
state            | streaming
sent_location    | 0/3000670
write_location   | 0/3000670
flush_location   | 0/3000670
replay_location  | 0/3000670
sync_priority    | 0
sync_state       | async
----

Also, you should be able to see that the replication processes are running on the standby server:
...
As you can see, the new database (i.e. `test`), got replicated to the standby.
...
1) Lags in Bytes: For calculating lags in bytes, users can use the `pg_stat_replication` view on the master with the function `pg_xlog_location_diff` function. Below is an example:
...
2) Calculating lags in Seconds. The following is SQL, which most people uses to find the lag in seconds:
...
[source, bash]
----
[root@onmssrv01 ~]# cd /etc/pgpool-II-95/
[root@onmssrv01 pgpool-II-95]# cp pgpool.conf.sample-stream pgpool.conf
----

Edit the following settings in the copied sample file `/etc/pgpool-II-95/pgpool.conf`:

WARNING: do not replace the contents of the file but edit everything listed under here.
...
num_init_children = 60 # Should be consistent with max_connections in postgresql.conf
max_pool = 1
...
load_balance_mode = on # WARNING: Be careful with this option
...
failover_command = '/etc/pgpool-II-95/failover.sh %h %H'
recovery_user = 'pgpool'
recovery_password = 'pgpool'
----

WARNING: Replace the sample password of the _pgpool_ user accordingly (not required for the _Vagrant lab_).

WARNING: Be sure that `num_init_children` is consistent with the required number of connections in _OpenNMS_ (/opt/opennms/etc/opennms-datasources.xml), and the configured `max_connections` in `postgresql.conf`.

WARNING: Be aware that even if having load balancing enabled sounds useful, this could lead to query cancelations when they are running on the stand-by server.
         This is due to the fact that the stand-by is slightly behind the primary, and will be eventually consistent (this time difference is the sum of the replication delay plus the apply delay).
         It is advised to have this feature disabled (`load_balance_mode=off`), and invest time improving the performance of the master if necessary.
         That way the stand-by will be treated just as a backup, for high-availability purposes only, and can be used for reporting capabilities (that doesn't require up to date data).

WARNING: The online recovery feature won’t be used.
...
IMPORTANT: For _RHEL/CentOS 6_, the `pid_file_name` must be `/var/run/pgpool-II-95/pgpool.pid`.
           For _RHEL/CentOS 7_ this is enforced through `pgpool-II-95.service` (the _systemd_ initialization script).
           That way, the content of `pgpool-II-95.conf` is the same for both operating systems.
...
[source, bash]
----
[root@onmssrv01 ~]$ chmod 0600 /etc/pgpool-II-95/pgpool.conf
[root@onmssrv01 ~]$ chown postgres:postgres /etc/pgpool-II-95/pgpool.conf
----
...
On the above settings, we specified that on failover, the script `failover.sh` should be executed, so we’ll need to create this file in `/etc/pgpool-II-95/failover.sh`:
...
[source, bash]
----
[root@onmssrv01 ~]$ chmod 0700 /etc/pgpool-II-95/failover.sh
[root@onmssrv01 ~]$ chown postgres:postgres /etc/pgpool-II-95/failover.sh
----

We also specified in the configuration that we want to use `pool_hba.conf`, so we need to add the credentials to the `/etc/pgpool-II-95/pool_hba.conf` file.
...
[source, bash]
----
[root@onmssrv01 ~]$ chmod 0600 /etc/pgpool-II-95/pool_hba.conf
[root@onmssrv01 ~]$ chown postgres:postgres /etc/pgpool-II-95/pool_hba.conf
----
...
[source, bash]
----
[root@onmssrv01 ~]# touch /etc/pgpool-II-95/pool_passwd
[root@onmssrv01 ~]# chmod 600 /etc/pgpool-II-95/pool_passwd
[root@onmssrv01 ~]# chown postgres:postgres /etc/pgpool-II-95/pool_passwd
----

Now, we can add users to the file.
...
[source, bash]
----
[root@onmssrv01 ~]# echo "postgres:e8a48653851e28c69d0506508fb27fc5" >> /etc/pgpool-II-95/pcp.conf
----
...
[source, bash]
----
[root@onmssrv01 ~]$ chmod 0600 /etc/pgpool-II-95/pcp.conf
[root@onmssrv01 ~]$ chown postgres:postgres /etc/pgpool-II-95/pcp.conf
----

At the end, you should have something like the following at `/etc/pgpool-II-95/`:
...
[source, bash]
----
[root@onmssrv01 ~]$ mkdir /var/log/pgpool-II-95
[root@onmssrv01 ~]$ chown postgres:postgres /var/log/pgpool-II-95
[root@onmssrv02 ~]$ mkdir /var/log/pgpool-II-95
[root@onmssrv02 ~]$ chown postgres:postgres /var/log/pgpool-II-95
----
...
[source, bash]
----
[root@onmssrv01 ~]# rsync -avr --delete /etc/pgpool-II-95/ onmssrv02:/etc/pgpool-II-95/
----
...
IMPORTANT: Remember to test the connection from the other _OpenNMS_ server (i.e. _onmssrv02_).
...
[source, bash]
----
[root@onmssrv01 ~]# grep pgpool /var/log/messages
Jun 17 14:04:33 onmssrv01 pgpool: 2016-06-17 14:04:33: pid 32076: LOG:  Backend status file /var/log/pgpool-II-95/pgpool_status does not exist
Jun 17 14:04:33 onmssrv01 pgpool: 2016-06-17 14:04:33: pid 32076: LOG:  Setting up socket for 0.0.0.0:9999
Jun 17 14:04:33 onmssrv01 pgpool: 2016-06-17 14:04:33: pid 32076: LOG:  Setting up socket for :::9999
Jun 17 14:04:33 onmssrv01 pgpool: 2016-06-17 14:04:33: pid 32076: LOG:  pgpool-II successfully started. version 3.5.2 (ekieboshi)
Jun 17 14:04:33 onmssrv01 pgpool: 2016-06-17 14:04:33: pid 32076: LOG:  find_primary_node: checking backend no 0
Jun 17 14:04:33 onmssrv01 pgpool: 2016-06-17 14:04:33: pid 32076: LOG:  find_primary_node: primary node id is 0
----
...
[source, bash]
----
[root@onmssrv01 ~]# systemctl status pgpool-II-95
● pgpool-II-95.service - PGPool-II Middleware Between PostgreSQL Servers And PostgreSQL Database Clients
   Loaded: loaded (/usr/lib/systemd/system/pgpool-II-95.service; disabled; vendor preset: disabled)
   Active: active (running) since Fri 2016-06-17 14:04:33 EDT; 47s ago
  Process: 32023 ExecStartPre=/usr/local/bin/dbcleanup.sh (code=exited, status=0/SUCCESS)
 Main PID: 32076 (pgpool)
   CGroup: /system.slice/pgpool-II-95.service
           ├─32076 /usr/pgpool-9.5/bin/pgpool -f /etc/pgpool-II-95/pgpool.conf -n --discard-status
           ├─32078 pgpool: wait for connection request
           ....
           ├─32139 pgpool: PCP: wait for connection request
           └─32140 pgpool: worker process

Jun 17 14:04:33 onmssrv01.local dbcleanup.sh[32023]: pg_terminate_backend
Jun 17 14:04:33 onmssrv01.local dbcleanup.sh[32023]: ----------------------
Jun 17 14:04:33 onmssrv01.local dbcleanup.sh[32023]: (0 rows)
Jun 17 14:04:33 onmssrv01.local systemd[1]: Started PGPool-II Middleware Between PostgreSQL Servers And PostgreSQL Database Clients.
Jun 17 14:04:33 onmssrv01.local pgpool[32076]: 2016-06-17 14:04:33: pid 32076: LOG:  Backend status file /var/log/pgpool-II-95/... exist
Jun 17 14:04:33 onmssrv01.local pgpool[32076]: 2016-06-17 14:04:33: pid 32076: LOG:  Setting up socket for 0.0.0.0:9999
Jun 17 14:04:33 onmssrv01.local pgpool[32076]: 2016-06-17 14:04:33: pid 32076: LOG:  Setting up socket for :::9999
Jun 17 14:04:33 onmssrv01.local pgpool[32076]: 2016-06-17 14:04:33: pid 32076: LOG:  pgpool-II successfully started. version 3....boshi)
Jun 17 14:04:33 onmssrv01.local pgpool[32076]: 2016-06-17 14:04:33: pid 32076: LOG:  find_primary_node: checking backend no 0
Jun 17 14:04:33 onmssrv01.local pgpool[32076]: 2016-06-17 14:04:33: pid 32076: LOG:  find_primary_node: primary node id is 0
...
Jun 17 14:04:33 onmssrv01.local pgpool[32076]: 2016-06-17 14:04:33: pid 32076: LOG:  Backend status file /var/log/pgpool-II-95/pgpool_status does not exist
Jun 17 14:04:33 onmssrv01.local pgpool[32076]: 2016-06-17 14:04:33: pid 32076: LOG:  Setting up socket for 0.0.0.0:9999
Jun 17 14:04:33 onmssrv01.local pgpool[32076]: 2016-06-17 14:04:33: pid 32076: LOG:  Setting up socket for :::9999
Jun 17 14:04:33 onmssrv01.local pgpool[32076]: 2016-06-17 14:04:33: pid 32076: LOG:  pgpool-II successfully started. version 3.5.2 (ekieboshi)
Jun 17 14:04:33 onmssrv01.local pgpool[32076]: 2016-06-17 14:04:33: pid 32076: LOG:  find_primary_node: checking backend no 0
Jun 17 14:04:33 onmssrv01.local pgpool[32076]: 2016-06-17 14:04:33: pid 32076: LOG:  find_primary_node: primary node id is 0
----
...
This should also work from another host that has network access to the _pgpool-II_ machine, assuming that host is has the appropriate permissions in /etc/pgpool-II-95/pool_hba.conf.
...
---------+-----------+------+--------+-----------+---------+------------
 0       | pgdbsrv01 | 5432 | 2      | 0.500000  | primary | 1
 1       | pgdbsrv02 | 5432 | 2      | 0.500000  | standby | 0
(2 rows)
----

If for some reason, the status is not 2 or you see problems on the logs, double check the configuration of _pgpool-II_ in `pgpool.conf` (specially the section related with the _PostgreSQL_ servers).
It might be possible that you must re-attach the failed server:

[source, bash]
----
[root@onmssrv01 ~]# pcp_attach_node -h localhost -p 9898 -U postgres X
----

Replace X with the `node_id` from the `show pool_nodes` command.

Finally, stop the _pgpool-II_ service:
...
WARNING: Remember to repeat the connection test from _onmssrv02_. Be sure that /etc/pgpool-II-95 has been synched between both servers.

=== Test Failover

In order to test the failover with _pgpool-II_, the application must be running on one of the _OpenNMS_ servers; so make sure it is running only on `onmssrv01` before continue.
...
[source, bash]
----
[root@pgdbsrv01 ~]# service postgresql-9.5 stop
----
...
[source, bash]
----
[root@pgdbsrv01 ~]# systemctl stop postgresql-9.5
----
...
Password for user pgpool:
 node_id | hostname  | port | status | lb_weight |  role   | select_cnt
---------+-----------+------+--------+-----------+---------+------------
 0       | pgdbsrv01 | 5432 | 3      | 0.500000  | standby | 0
 1       | pgdbsrv02 | 5432 | 2      | 0.500000  | primary | 0
(2 rows)
----
...
[source, bash]
----
[root@pgdbsrv02 ~]# su - postgres -c " /usr/pgsql-9.5/bin/repmgr -f /etc/repmgr/9.5/repmgr.conf cluster show"
[2016-06-17 14:46:48] [INFO] connecting to database
Role      | Name      | Upstream | Connection String
----------+-----------|----------|-----------------------------------------
[2016-06-17 14:46:48] [ERROR] connection to database failed: could not connect to server: Connection refused
	Is the server running on host "pgdbsrv01" (192.168.205.153) and accepting
	TCP/IP connections on port 5432?

  FAILED  | pgdbsrv01 |          | host=pgdbsrv01 user=repmgr dbname=repmgr
* master  | pgdbsrv02 |          | host=pgdbsrv02 user=repmgr dbname=repmgr
----

The failover script should add some useful information to `/var/log/pgpool-II-95/pgpool_failover.log`, when a failover happens:

[source, bash]
----
[root@onmssrv01 ~]# cat /var/log/pgpool-II-95/pgpool_failover.log
Fri Jun 17 14:44:49 EDT 2016
Failed node: pgdbsrv01, Promoting pgdbsrv02 ...
+ /usr/bin/ssh -T -l postgres pgdbsrv02 '/usr/pgsql-9.5/bin/repmgr -f /etc/repmgr/9.5/repmgr.conf standby promote 2>/dev/null 1>/dev/null <&-'
+ exit 0
----
...
In the meanwhile, the database has got some updates and changes so we need to make sure that those get replicated to _pgdbsrv01_ before we start it as a standby.

There are two way to perform the sync operation:

(1) Perform a full synchronization, in other words, recreate the whole `/var/lib/pgsql/9.5/data` directory from scratch:

[source, bash]
----
[root@pgdbsrv01 ~]# su - postgres
-bash-4.1$ rm -rf 9.5/data/
-bash-4.1$ /usr/pgsql-9.5/bin/repmgr -f /etc/repmgr/9.5/repmgr.conf --verbose -D /var/lib/pgsql/9.4/data -d repmgr -p 5432 -U repmgr -R postgres standby clone pgdbsrv02
[2016-06-17 14:49:37] [NOTICE] using configuration file "/etc/repmgr/9.5/repmgr.conf"
[2016-06-17 14:49:37] [NOTICE] destination directory '/var/lib/pgsql/9.4/data' provided
[2016-06-17 14:49:37] [INFO] connecting to upstream node
[2016-06-17 14:49:37] [INFO] connected to upstream node, checking its state
[2016-06-17 14:49:37] [INFO] Successfully connected to upstream node. Current installation size is 28 MB
[2016-06-17 14:49:37] [INFO] creating directory "/var/lib/pgsql/9.4/data"...
[2016-06-17 14:49:37] [NOTICE] starting backup (using pg_basebackup)...
[2016-06-17 14:49:37] [HINT] this may take some time; consider using the -c/--fast-checkpoint option
[2016-06-17 14:49:37] [INFO] executing: '/usr/pgsql-9.5/bin/pg_basebackup -l "repmgr base backup"  -D /var/lib/pgsql/9.4/data -h pgdbsrv02 -p 5432 -U repmgr --xlog-method=stream'
[2016-06-17 14:49:38] [NOTICE] standby clone (using pg_basebackup) complete
[2016-06-17 14:49:38] [NOTICE] you can now start your PostgreSQL server
[2016-06-17 14:49:38] [HINT] for example : pg_ctl -D /var/lib/pgsql/9.4/data start
[2016-06-17 14:49:38] [HINT] After starting the server, you need to register this standby with "repmgr standby register"
----
...
----
[root@pgdbsrv01 ~]# su - postgres
-bash-4.1$ /usr/pgsql-9.5/bin/repmgr -f /etc/repmgr/9.5/repmgr.conf --verbose --force --rsync-only -D /var/lib/pgsql/9.5/data -d repmgr -p 5432 -U repmgr -R postgres standby clone pgdbsrv02
[2016-06-17 14:53:20] [NOTICE] using configuration file "/etc/repmgr/9.5/repmgr.conf"
[2016-06-17 14:53:20] [NOTICE] destination directory '/var/lib/pgsql/9.5/data' provided
[2016-06-17 14:53:20] [INFO] connecting to upstream node
[2016-06-17 14:53:20] [INFO] connected to upstream node, checking its state
[2016-06-17 14:53:20] [INFO] Successfully connected to upstream node. Current installation size is 28 MB
[2016-06-17 14:53:20] [INFO] creating directory "/var/lib/pgsql/9.5/data"...
[2016-06-17 14:53:20] [NOTICE] starting backup (using rsync)...
[2016-06-17 14:53:21] [INFO] standby clone: master data directory '/var/lib/pgsql/9.5/data'
[2016-06-17 14:53:21] [INFO] rsync command line: 'rsync --archive --checksum --compress --progress --rsh=ssh --delete --checksum --exclude=postmaster.pid --exclude=postmaster.opts --exclude=global/pg_control --exclude=recovery.conf --exclude=recovery.done --exclude=postgresql.auto.conf.tmp --exclude=pgsql_tmp* --exclude=pg_xlog/* --exclude=pg_log/* --exclude=pg_stat_tmp/* postgres@pgdbsrv02:/var/lib/pgsql/9.5/data/* /var/lib/pgsql/9.5/data'
receiving incremental file list
.....
sent 21861 bytes  received 3528512 bytes  2366915.33 bytes/sec
total size is 30168542  speedup is 8.50
[2016-06-17 14:53:22] [INFO] read_backup_label: parsing backup label file '/var/lib/pgsql/9.5/data/backup_label'
Label: repmgr_standby_clone_1466189601; file: 000000020000000000000009
[2016-06-17 14:53:22] [INFO] standby clone: local control file '/var/lib/pgsql/9.5/data/global'
[2016-06-17 14:53:22] [INFO] standby clone: master control file '/var/lib/pgsql/9.5/data/global/pg_control'
[2016-06-17 14:53:22] [INFO] rsync command line: 'rsync --archive --checksum --compress --progress --rsh=ssh --delete --checksum postgres@pgdbsrv02:/var/lib/pgsql/9.5/data/global/pg_control /var/lib/pgsql/9.5/data/global'
receiving incremental file list
pg_control
        8192 100%    7.81MB/s    0:00:00 (xfer#1, to-check=0/1)

sent 30 bytes  received 268 bytes  596.00 bytes/sec
total size is 8192  speedup is 27.49
[2016-06-17 14:53:22] [NOTICE] notifying master about backup completion...
NOTICE:  pg_stop_backup complete, all required WAL segments have been archived
[2016-06-17 14:53:23] [NOTICE] standby clone (using rsync) complete
[2016-06-17 14:53:23] [NOTICE] you can now start your PostgreSQL server
[2016-06-17 14:53:23] [HINT] for example : pg_ctl -D /var/lib/pgsql/9.5/data start
[2016-06-17 14:53:23] [HINT] After starting the server, you need to register this standby with "repmgr standby register"
----
...
[source, bash]
----
[root@pgdbsrv01 ~]# sudo su - postgres -c " /usr/pgsql-9.5/bin/repmgr -f /etc/repmgr/9.5/repmgr.conf cluster show"
[2016-06-17 14:55:14] [INFO] connecting to database
Role      | Name      | Upstream | Connection String
----------+-----------|----------|-----------------------------------------
  standby | pgdbsrv01 |          | host=pgdbsrv01 user=repmgr dbname=repmgr
* master  | pgdbsrv02 |          | host=pgdbsrv02 user=repmgr dbname=repmgr
----
...
[source, bash]
----
[root@onmssrv01 ~]# pcp_attach_node -h localhost -p 9898 -U postgres 0
Password:
...
Password for user pgpool:
 node_id | hostname  | port | status | lb_weight |  role   | select_cnt
---------+-----------+------+--------+-----------+---------+------------
 0       | pgdbsrv01 | 5432 | 2      | 0.500000  | standby | 0
 1       | pgdbsrv02 | 5432 | 2      | 0.500000  | primary | 0
(2 rows)
----

For the `pcp_attach_node` command, it is required to use the authentication credentials defined on `/etc/pgpool-II-95/pcp.conf`. Also, it is required to know the node_id of the node you want to re-attach. The "show pool_nodes" command will give you all the information (including the `node_id`).
...
[source, bash]
----
[root@pgdbsrv02 ~]# service postgresql-9.5 stop
----
...
[source, bash]
----
[root@pgdbsrv02 ~]# systemctl stop postgresql-9.5
----
...
Password for user pgpool:
 node_id | hostname  | port | status | lb_weight |  role   | select_cnt
---------+-----------+------+--------+-----------+---------+------------
 0       | pgdbsrv01 | 5432 | 2      | 0.500000  | primary | 0
 1       | pgdbsrv02 | 5432 | 3      | 0.500000  | standby | 0
(2 rows)
----
...
----
[root@pgdbsrv02 ~]# sudo su - postgres
-bash-4.2$ /usr/pgsql-9.5/bin/repmgr -f /etc/repmgr/9.5/repmgr.conf --verbose --force --rsync-only -D /var/lib/pgsql/9.5/data -d repmgr -p 5432 -U repmgr -R postgres standby clone pgdbsrv01
----

Then, start the _postgresql-9.5_ service.
...
[source, bash]
----
[root@onmssrv01 ~]# pcp_attach_node -h localhost -p 9898 -U postgres 1
Password:
pcp_attach_node -- Command Successful
...
Password:
pcp_attach_node -- Command Successful
[root@onmssrv01 log]#  psql -U pgpool -h onmssrv01 -p 9999 -d postgres -c "show pool_nodes"
Password for user pgpool:
 node_id | hostname  | port | status | lb_weight |  role   | select_cnt
---------+-----------+------+--------+-----------+---------+------------
 0       | pgdbsrv01 | 5432 | 2      | 0.500000  | primary | 0
...
In case you have trouble starting the _pgpool-II_ service, be sure that it is not running on the other _OpenNMS_ machine, and also that the socket files (i.e. `/tmp/.s.PGSQL.9898` and `/tmp/.s.PGSQL.9999`) don’t exist.
If they exist, remove them prior start.
In theory this cleanup is always performed by the _pgpool-II_ initialization script, but it is important to understand why.

The cleanup is performed through the script located at `/usr/local/bin/dbcleanup.sh` as mentioned on an earlier section.
The reason to have this integrated with the _pgpool-II_ initialization script is to be sure that _OpenNMS_ will be able to initialize the _DB Connection Pool_ without issues.
Because of this, prior every single start request of the _OpenNMS_ application (either manually or through the cluster), _pgpool-II_ must be restarted first.
